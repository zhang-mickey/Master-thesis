...
def parse_args():
    ...
    parser.add_argument("--pseudo_labels_path", type=str, default=os.path.join(project_root,"data/pseudo_labels"), help="Path to the pseudo labels generated by classification.py")
    parser.add_argument("--save_model_path", type=str, default=os.path.join(project_root,"model/model_weakly.pth"), help="Path to save the trained model")
    #Train 
